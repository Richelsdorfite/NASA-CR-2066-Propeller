#!/usr/bin/env python
"""Test quantity and cost display"""
...
geometry = PropellerGeometry(
    ...
    ZMWT=0.187,
    WTCON=1.0,
    CLF1=0.0,      # Use default
    CLF=0.0,       # Use default
    CAMT=0.0,      # Use default qty
    DAMT=100.0,    # Add 100 units per step
    NAMT=3         # 3 quantity levels
)
